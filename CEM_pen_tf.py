...
if __name__ == '__main__':
    ...
    dx_model = construct_model(obs_dim=obs_shape, act_dim=action_shape, hidden_dim=20, num_networks=1, num_elites=1)
    cost_model = construct_cost_model(obs_dim=obs_shape, act_dim=action_shape, hidden_dim=20, num_networks=1, num_elites=1)

    my_dx = neural_bays_dx_tf(args, dx_model, "dx", obs_shape, device, sigma_n2=0.001**2,sigma2=0.01**2)

    my_cost = neural_bays_dx_tf(args, cost_model, "cost", 1, device, sigma_n2 = 0.001**2,sigma2 = 0.01**2)
