...
if __name__ == '__main__':
    ...
    my_dx = neural_bays_dx_tf(args, dx_model, "dx", obs_shape, sigma2=0.1**2, sigma_n2=0.0001**2)

    my_cost = neural_bays_dx_tf(args, cost_model, "cost", 1, sigma2=0.1**2, sigma_n2=0.0001**2)
