...
import torch
from tf_models.constructor import construct_shallow_model, construct_shallow_cost_model
...
if __name__ == '__main__':
    ...
    parser.add_argument('--num-iters', type=int, default=500, metavar='NS',
    ...
    my_dx = neural_bays_dx_tf(args, dx_model, "dx", obs_shape, device, sigma_n2=0.01**2,sigma2= 1**2)

    my_cost = neural_bays_dx_tf(args, cost_model, "cost", 1, device, sigma_n2 = 0.01**2,sigma2 = 1**2)
