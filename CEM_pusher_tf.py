...
if __name__ == '__main__':
    ...
    parser.add_argument('--sigma', type=float, default=1e-05, metavar='T', help='var for betas')
    parser.add_argument('--sigma_n', type=float, default=1e-08, metavar='T', help='var for noise')
    ...
    for episode in range(num_episode):
        ...
        cem = CEM(env, args, my_dx, num_elites = args.num_elites, num_trajs = args.num_trajs, alpha = args.alpha, device = device)
        ...
        np.savetxt('pusher_r.txt',np.array(avg_loss))
        print(avg_loss)