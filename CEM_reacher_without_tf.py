...
if __name__ == '__main__':
    ...
    parser.add_argument('--training-iter-dx', type=int, default=100,metavar='NS', help='iterations in training nn')
    parser.add_argument('--hidden-dim-cost', type=int, default =200, metavar='NS')
    parser.add_argument('--training-iter-cost', type=int, default=100, metavar='NS', help='iterations in training nn')
    ...
    parser.add_argument('--epsilon', type=float, default=0.01, metavar='NS', help='threshold for cem iteration')
    ...
    # cost_model = CostdeepNet(args, obs_shape, action_shape).to(device)
    ...
    # transition function
    my_dx = neural_bays_dx_tf(args, dx_model, "dx", obs_shape, device, sigma_n2=1e-3**2,sigma2=1e-4**2)
    ...
    # reward function
    my_cost = neural_bays_dx_tf(args, cost_model, "cost", 1, device, sigma_n2=1e-3**2,sigma2=1e-4**2)
