...
from tf_models.constructor import construct_model,construct_shallow_model
...
class CEM():
    ...
    def hori_planning(self, cur_s):
        ...
        init_vars = np.ones(self.action_shape * self.plan_hor)
        means = init_means
        vars = init_vars
...
if __name__ == '__main__':
    ...
    my_dx = neural_bays_dx_tf(args, dx_model, "dx", obs_shape, device, sigma2=0.01**2, sigma_n2=args.sigma_n**2)
    ...
    for episode in range(num_episode):
        ...
        np.savetxt('cartpole.txt', np.array(avg_loss))